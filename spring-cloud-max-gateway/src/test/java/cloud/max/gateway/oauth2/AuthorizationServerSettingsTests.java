package cloud.max.gateway.oauth2;
...
class AuthorizationServerSettingsTests {
	...
	void remotePassport() throws JsonProcessingException {
		...
		List<String> list = Arrays.asList(
				"http://max-passport/.well-known/oauth-authorization-server",
				"http://max-gateway/passport/.well-known/oauth-authorization-server");
		// @formatter:on
